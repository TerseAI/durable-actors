...
${methodTypes(actor.actorName, actor.rpc.methods, stubName, methodsName)}
        ...
        descriptor: actorDescriptor(
            actor.actorName,
            `get(actorId: string, transport?: import("./runtime/types.js").ActorRpcTransport): ${stub} {
...
function actorDescriptor(actorName: string, rpc?: string): string {
    ...
    prepareWebsocket(
        ...
        options: import("./runtime/types.js").SocketProxyOptions = {},
        dependencies: import("./runtime/types.js").SocketProxyDependencies = {}
    ): Promise<import("./runtime/types.js").SocketGrant> {
