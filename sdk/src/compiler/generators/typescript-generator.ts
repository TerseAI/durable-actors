...
/** Returns the typed client and its standalone runtime without writing files or executing actor code. */
...
${proxySource(contracts)}`
    ...
    return new Map([["index.ts", formatted], ...Object.entries(runtimeFiles)])
}
