WITH inserted AS (
    INSERT INTO durable_actors_traces (
        ...
        outcome, duration_ms, queue_wait_ms, kind, operation, connection_id, host_id, request_id
    )
    ...
    FROM unnest(
        ...
        $13::text[], $14::text[], $15::bytea[]
    ) WITH ORDINALITY AS batch(
        event_id, event, started_at_ms, actor_name, actor_id, outcome, duration_ms,
        queue_wait_ms, kind, operation, connection_id, host_id, request_id, ordinal
    )
